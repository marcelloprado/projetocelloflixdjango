"""
Django settings for celloflix project.
...
WSGI_APPLICATION = 'celloflix.wsgi.application'
...
DATABASE_URL = 'postgres://projetocelloflixdjango-production.up.railway.app'
if DATABASE_URL:
    DATABASES = {
